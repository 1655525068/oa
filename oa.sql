...
INSERT INTO `ao_three_book` VALUES (40,NULL,'FCR','FCR-LD-X-CN23-000096','关于1116XML05BZS07贯穿件图册钢板材质和厚度替换的变更（管道）','A','有效','马文灿','Y','2024-08-08','2024-08-21','Y','LDX-ML05-V2-317-B213','1116XML05BZS07-054','A','管道','建安承包','李季','王博辰','是','细化','ICR-PT-1-12-00049','2024-7-3','施工承包商','烦烦烦','是',NULL,NULL,'','',''),(41,NULL,'FCR','FCR-LD-X-CN23-000096','关于1116XML05BZS07贯穿件图册钢板材质和厚度替换的变更（管道）','A','有效','马文灿','Y','2024-08-08','2024-08-12','Y','LDX-ML05-V2-317-B213','1116XML05BZS07-054','A','管道','建安承包','李季','王博辰','是','细化','ICR-PT-1-12-00049','2024-7-3',' 方法士大夫','烦烦烦','否',NULL,NULL,'22','33','');
...
INSERT INTO `aoa_sys_menu` VALUES (1,1,NULL,'glyphicon-cog','系统管理','##',0,0),(2,1,NULL,'glyphicon-education','用户管理','#',0,2),(3,1,NULL,'glyphicon-user','角色列表','#',0,3),(5,1,NULL,'glyphicon-hourglass','流程管理','#',0,5),(8,1,NULL,'glyphicon-flag','任务管理','#',0,8),(10,1,NULL,'glyphicon-earphone','通讯录','#',0,13),(11,1,NULL,'glyphicon-record','菜单管理','/testsysmenu',1,2),(12,1,NULL,'glyphicon-record','类型管理','/testsystype',1,1),(13,1,NULL,'glyphicon-record','状态管理','/testsysstatus',1,3),(14,1,NULL,'glyphicon-record','部门管理','/deptmanage',2,1),(15,1,NULL,'glyphicon-record','职位管理','/positionmanage',2,3),(16,1,NULL,'glyphicon-record','用户管理','/usermanage',2,4),(17,1,NULL,'glyphicon-record','在线用户','/morelogrecord',2,2),(18,1,NULL,'glyphicon-record','角色列表','/rolemanage',3,1),(19,1,NULL,'glyphicon-record','我的申请','/flowmanage',5,1),(20,1,NULL,'glyphicon-record','流程审核','/audit',5,2),(21,1,NULL,'glyphicon-record','新建流程','/xinxeng',5,0),(22,1,NULL,'glyphicon-record','账号管理','/accountmanage',7,1),(23,1,NULL,'glyphicon-record','三单任务管理','/taskmanage',8,1),(24,1,NULL,'glyphicon-record','我的任务','/mytask',8,2),(25,1,NULL,'glyphicon-record','通讯录','/addrmanage',10,1);
...
INSERT INTO `aoa_task_list` VALUES (101,'评价33','2024-08-14 15:43:31',0,0,'2024-08-13 15:49:15','2024-08-13 15:49:15','2024-08-13 15:43:31',7,'描述33',NULL,'45678',NULL,42,'李季',41);
...
) ENGINE=InnoDB AUTO_INCREMENT=3299 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-08-14  8:42:23
