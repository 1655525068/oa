package cn.gson.oa.common.utils;

import cn.gson.oa.common.utils.XmlReader;
import cn.gson.oa.dto.freemarker.input.ExcelImageInput;
...
import cn.gson.oa.model.entity.excel.*;
import cn.gson.oa.util.ColorUtil;
...
public class FreemarkerUtils {
    ...
    public static void exportImageExcelNew(HttpServletResponse response, FreemarkerInput freemarkerInput,String fileName) {
        try {
            ...
            response.setHeader("Content-Disposition",
                    "attachment;filename=\"" + new String((fileName + ".xlsx").getBytes("GBK"),
                            "ISO8859-1") + "\"");
    ...
    public static Map<String, Style> readXmlStyle(Document document) {
        Map<String, Style> styleMap = cn.gson.oa.common.utils.XmlReader.getStyle(document);
        return styleMap;
    }
