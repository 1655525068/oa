...
import cn.gson.oa.mappers.AddressMapper;
import cn.gson.oa.model.dao.address.AddressDao;
import cn.gson.oa.model.dao.address.AddressUserDao;
import cn.gson.oa.model.dao.notedao.AttachService;
...
import cn.gson.oa.model.entity.note.DirectorUser;
...
public class AddrController {
    ...
    public String addrmanage(@SessionAttribute("userId") Long userId, Model model,
        ...
        Pageable pa = new PageRequest(page, size, new Sort(Direction.ASC, "role"));
