...
public interface MailreciverDao extends PagingAndSortingRepository<Mailreciver, Long>{
	...
	//收件箱查询
	@Query("select new cn.gson.oa.model.entity.mail.Pagemail(list.mailId,list.mailType,list.mailStatusid,list.mailTitle,list.inReceiver,list.mailFileid.attachmentId,list.mailCreateTime,mr.star,mr.read) "
