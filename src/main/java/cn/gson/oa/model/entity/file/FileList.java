package cn.gson.oa.model.entity.file;
...
public class FileList {
	...
	@ManyToOne
	@JoinColumn(name = "path_before_trash")
	@JsonIgnore
	private FilePath pbtrash;
	...
	public FilePath getPbtrash() {
		return pbtrash;
	}

	public void setPbtrash(FilePath pbtrash) {
		this.pbtrash = pbtrash;
	}
